...
upload queue can be filled and saved by FormIt hooks.
...
With two FormIt hooks the upload queue can be pre filled from FormIt field
value and saved into FormIt field value. With a third FormIt hook uploaded
files can be attached to the FormIt mails.
